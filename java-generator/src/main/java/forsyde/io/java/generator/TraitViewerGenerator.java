...
//                    }
                    ...
                    throw new IllegalArgumentException("At " + viewerInterface.getSimpleName().toString() + " Lists are not supported. Use Sets and properties with your ordering scheme to achieve proper listing");
                }
