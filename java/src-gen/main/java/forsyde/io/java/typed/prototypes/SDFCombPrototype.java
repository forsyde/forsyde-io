...
import forsyde.io.java.typed.interfaces.ISDFComb;
...
public final class SDFCombPrototype extends Vertex implements ISDFComb {
  ...
  public static Boolean conforms(Vertex vertex) {
    return vertex.vertexTraits.contains(VertexTrait.SDFComb);
  }
}
