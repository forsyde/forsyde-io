...
import forsyde.io.java.typed.interfaces.IReactorTimer;
import java.lang.Boolean;
import java.lang.Integer;
import java.util.HashSet;

public final class ReactorTimerPrototype extends Vertex implements IReactorTimer {
  ...
  public static Boolean conforms(Vertex vertex) {
    return vertex.vertexTraits.contains(VertexTrait.ReactorTimer);
  }
}
