...
import forsyde.io.java.typed.interfaces.IInstrumentedFunction;
import java.lang.Boolean;
import java.lang.Integer;
import java.lang.String;
import java.util.Map;

public final class InstrumentedFunctionPrototype extends Vertex implements IInstrumentedFunction {
  ...
  public static Boolean conforms(Vertex vertex) {
    return vertex.vertexTraits.contains(VertexTrait.InstrumentedFunction);
  }
}
