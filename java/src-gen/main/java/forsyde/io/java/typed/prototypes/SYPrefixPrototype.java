...
import forsyde.io.java.typed.interfaces.ISYPrefix;
import java.lang.Boolean;
import java.util.Optional;

public final class SYPrefixPrototype extends Vertex implements ISYPrefix {
  ...
  public static Boolean conforms(Vertex vertex) {
    return vertex.vertexTraits.contains(VertexTrait.SYPrefix);
  }
}
