...
import forsyde.io.java.typed.interfaces.InstrumentedSignalPrototype;
...
public final class InstrumentedSignal extends Vertex implements InstrumentedSignalPrototype {
  ...
  public static Boolean conforms(Vertex vertex) {
    return vertex.vertexTraits.contains(VertexTrait.InstrumentedSignalTrait);
  }
}
