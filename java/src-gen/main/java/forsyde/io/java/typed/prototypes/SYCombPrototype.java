...
import forsyde.io.java.typed.interfaces.ISYComb;
import java.lang.Boolean;
import java.util.Optional;

public final class SYCombPrototype extends Vertex implements ISYComb {
  ...
  public static Boolean conforms(Vertex vertex) {
    return vertex.vertexTraits.contains(VertexTrait.SYComb);
  }
}
