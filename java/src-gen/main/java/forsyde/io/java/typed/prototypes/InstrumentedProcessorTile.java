...
import forsyde.io.java.typed.interfaces.InstrumentedProcessorTilePrototype;
...
public final class InstrumentedProcessorTile extends Vertex implements InstrumentedProcessorTilePrototype {
  ...
  public static Boolean conforms(Vertex vertex) {
    return vertex.vertexTraits.contains(VertexTrait.InstrumentedProcessorTileTrait);
  }
}
