...
public class ForSyDe2AmaltheaOSAdapter {

    static public void fromVertexesToOSModel(ForSyDeModel model, Amalthea target, Map<Vertex, INamed> cache) {
