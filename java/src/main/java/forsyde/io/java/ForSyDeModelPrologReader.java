 ...
 *
 */
public class ForSyDeModelPrologReader {
...
//		matcher.find();
//		ModelType type = TypesFactory.getTypeFromName(matcher.group(2)).orElseThrow();
//		model.addVertex(
//			Vertex.builder()
...
//				.findFirst()
//				.orElseThrow();
//		ModelType type = TypesFactory.getTypeFromName(matcher.group(3)).orElseThrow();
//		vertex.ports.add(
//				Port.builder()
...
//		ModelType type = TypesFactory.getTypeFromName(matcher.group(5)).orElseThrow();
